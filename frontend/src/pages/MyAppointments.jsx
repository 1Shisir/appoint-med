      ...
      <div>
        {doctors.slice(0, 3).map((item,index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            <div>
              <img className='w-32 bg-indigo-50 hover:bg-indigo-200' src={item.image} alt="" />
            </div>
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span>18 Sep, 2024 | 7:52 PM</p>
            </div>
            <div></div>
